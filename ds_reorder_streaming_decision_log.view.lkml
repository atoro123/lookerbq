view: ds_reorder_streaming_decision_log {
  ...
  dimension_group: reminder_date {
    ...
    sql: TIMESTAMP(${TABLE}.reminder_date) ;;
  }
  ...
  dimension: merchant_id {
    ...
    sql:  CASE WHEN ds_reorder_streaming_decision_log.merchant_public_id = '01f0c9fad4ce11e5a256bc764e106cf4' THEN 145
          ...
          WHEN ds_reorder_streaming_decision_log.merchant_public_id = '85cfa0c6425311e89bdabc764e1107f2' THEN 202
          WHEN ds_reorder_streaming_decision_log.merchant_public_id = '4dcff40029ab11e5b9c4bc764e106cf4' THEN 127
          WHEN ds_reorder_streaming_decision_log.merchant_public_id = 'ba70f69df3f4655a4f9b762838d36aca' THEN 43
          WHEN ds_reorder_streaming_decision_log.merchant_public_id = 'a2bdf3ba8876ba9256f5bbba9ee29af8' THEN 37
          else null end
          ;;
  }
