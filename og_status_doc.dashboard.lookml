- dashboard: ordergroove_monthly_program_performance_report
  ...
  - name: Monthly Program Performance
    type: text
    title_text: Monthly Program Performance
    subtitle_text: ''
    row: 15
    col: 0
    width: 24
  ...
  - name: Order Performance
    type: text
    title_text: Order Performance
    subtitle_text: Month over Month Comparison
    row: 68
    col: 0
    width: 24
    height: 2
  - name: Subscription and Subscriber Performance
    type: text
    title_text: Subscription and Subscriber Performance
    subtitle_text: Month over Month Comparison
    row: 28
    col: 0
    width: 24
    height: 2
  - name: Impulse Upsell Metrics
    type: text
    title_text: Impulse Upsell Metrics
    subtitle_text: Month over Month Comparison
    row: 89
    col: 0
    width: 24
  ...
  - title: Total Revenue from IU
    ...
    width: 8
    height: 3
  - name: merge-cWcFJsH379FnLOxeulpiJp-126
    type: text
    title_text: "% of Orders with Impulse Upsell Items"
  ...
  - title: Frequency Distribution
    ...
    width: 12
    height: 9
  - name: merge-oJGM5cJBrGQSxyFkWFmv76-133
    type: text
    ...
    width: 12
    height: 8
  - name: merge-pa1y27Nqxvh38ukid9stgA-74
    type: text
  ...
  - title: 'IU Distribution: Subscription vs One-Time Adds'
    ...
    width: 12
    height: 8
  - name: merge-2Te0ColzbsvkV1BTkaKA7m-143
    type: text
  ...
  - title: Retention Rate
    ...
    - subscription_monthly_summary.Stagger_Month_month
    fill_fields:
    - subscription_monthly_summary.Stagger_Month_month
    filters:
      subscription_monthly_summary.Stagger_Month_month: 2 months ago for 2 months
    sorts:
    - subscription_monthly_summary.Stagger_Month_month desc
    limit: 500
    column_limit: 50
    dynamic_fields:
  ...
  - title: Average Order Value
    ...
    width: 8
    height: 3
  - name: merge-ckWbkMAgj62NoCcRom0t42-75
    type: text
    ...
    width: 24
    height: 10
  - name: merge-M0XaVktyI5DUMOjphJewHT-88
    type: text
