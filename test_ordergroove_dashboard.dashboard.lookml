- dashboard: ordergroove_monthly_program_performance_report
  ...
  - title: Active Subscriptions
    ...
    custom_color: "#00a7e0"
    show_single_value_title: true
    single_value_title: <font font-family="Comic Sans MS" size="25">Active Subscriptions</font>
    value_format: ''
    show_comparison: false
    comparison_type: value
    comparison_reverse_colors: false
    ...
    width: 12
    height: 5
  - name: <font face="Arial" size="10">Active Snapshot</font>
    type: text
    title_text: <font face="Arial" size="10">Active Snapshot</font>
    body_text: ''
    row: 3
    col: 0
    width: 24
    height: 2
  - name: <font face="Arial" size="10">Program Health</font>
    type: text
    title_text: <font face="Arial" size="10">Program Health</font>
    ...
    width: 24
    height: 3
  - name: <font face="Arial" size="10">Monthly Program Performance</font>
    type: text
    title_text: <font face="Arial" size="10">Monthly Program Performance</font>
    subtitle_text: ''
    row: 19
    col: 0
    width: 24
    height: 3
  - name: <font face="Arial" size="10">Subscription and Subscriber Performance</font>
    type: text
    title_text: <font face="Arial" size="10">Subscription and Subscriber Performance</font>
    subtitle_text: Month over Month Comparison
    row: 32
    col: 0
    width: 24
    height: 3
  - name: <font face="Arial" size="10">Order Performance</font>
    type: text
    title_text: <font face="Arial" size="10">Order Performance</font>
    subtitle_text: Month over Month Comparison
    row: 73
    col: 0
    width: 24
    height: 3
  - name: <font face="Arial" size="10">Impulse Upsell Metrics</font>
    type: text
    title_text: <font face="Arial" size="10">Impulse Upsell Metrics</font>
    subtitle_text: Month over Month Comparison
    row: 95
    col: 0
    width: 24
    height: 3
  - name: <font face="Arial" size="10">Churn Metrics</font>
    type: text
    title_text: <font face="Arial" size="10">Churn Metrics</font>
    subtitle_text: Month over Month Comparison
    row: 116
    col: 0
    width: 24
