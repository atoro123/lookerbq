view: subscription_subscription {
  ...
  dimension: Program {
    type: string
    sql: case when ${offer_id} in (2348,4356,2750,2762,2347,3895) then "illylovers Coffee (Select)"
         when ${offer_id} in (2346,3061,3221,3232,3369,3327,2751,2763) then "illylovers Machine (Select)"
        when ${offer_id} in (3769,3680,3681,3682,3683,3684,3685,3686,3687,3043,3044,3045,3046,3047,3048,3049,3050,3051,3052,3412,3413,3414,3415,3416,3417,3418,3419,3420,3421,
